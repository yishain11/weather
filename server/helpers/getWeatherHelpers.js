...
function getWeatherData(lat, long) {
    const url = `${weatherUrl}latitude=${lat}&longitude=${long}&daily=weathercode,temperature_2m_max,temperature_2m_min,uv_index_max,rain_sum,precipitation_hours,windspeed_10m_max&timezone=auto&timeformat=iso8601`;
    return fetch(url)
        .then(res => res.json())
